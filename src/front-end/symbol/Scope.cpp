...
Scope::Scope(sptr<Scope> parent_scope, unordered_map<string, Symbol *> symbolTable)
...
LookupResult Scope::lookupLocal(const string &name) const {
...
LookupResult Scope::lookup(const string &name) const {
